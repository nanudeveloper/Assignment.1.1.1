...
function getTotalCartPrice(newItemPrice, cartTotal, Shoes, Bag, Jacket) {
  let totalCartValue;
...
app.get('/cart-total', (req, res) => {
  ...
  let Shoes = parseFloat(req.query.Shoes);
  let Bag = parseFloat(req.query.Bag);
  let Jacket = parseFloat(req.query.Jacket);

  res.send(
    getTotalCartPrice(newItemPrice, cartTotal, Shoes, Bag, Jacket).toString()
  );
});
